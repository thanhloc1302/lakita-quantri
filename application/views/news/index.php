				...
				<div class="portlet box light-grey">
					...
					<div class="portlet-title">
						...
						<div class="caption">
							...
							<i class="fa fa-file-text"></i> Danh sách tin tức (<?php echo number_format($total); ?> bản ghi)
					...
					<div class="portlet-body">
						...
						<div class="table-toolbar">
							...
							<div class="btn-group">
								...
								<a class="btn green" href="<?php echo base_url();?>news/update"><i class="fa fa-plus"></i> Thêm mới</a>
							...
							<div class="btn-group pull-right">
								...
								<form action="<?php echo base_url();?>news/search" method="post">
		                            ...
		                            <button type="submit" onclick="window.location = window.location.protocol + '//' + window.location.host + '/' + 'news/index'; return false;" class="btn red">Hủy</button>
						...
						<table class="table table-striped table-bordered table-hover" id="sample_1">
							...
							<tbody>
                				...
                				<form class="form-horizontal" role="form" action="<?php echo base_url();?>news/delete" method="POST" id="form-del">
									...
									<tr class="odd gradeX">
										...
										<td>
											...
											<a href="<?php echo base_url().'news/update/'.$value['id']; ?>">
										...
										<td class="center">
											...
											<?php if($value['menu_parent']>0) $cate1 = $this->lib_mod->detail('category', array('id'=>$value['menu_parent']));

											if($value['menu_id']>0) $cate2 = $this->lib_mod->detail('category', array('id'=>$value['menu_id']));
										...
										<td>
											...
											<?php if($value['status']){ ?>
												...
												<a href="<?php echo base_url().'news/status/'.$value['id'].'/'.$value['status']; ?>" class="txt-center btn btn-sm green filter-cancel curr_segment"><i class="fa fa-check"></i></a>												

											<?php }else{ ?>

												<a href="<?php echo base_url().'news/status/'.$value['id'].'/'.$value['status']; ?>" class="txt-center btn btn-sm yellow filter-cancel curr_segment"><i class="fa fa-times"></i></a>												
										...
										<td class="center">
											...
											<a href="<?php echo base_url().'news/update/'.$value['id']; ?>" class="btn default btn-xs purple curr_segment">
											...
											<a href="<?php echo base_url().'news/delete/'.$value['id']; ?>" onclick="return confirm('Bạn chắc chắn muốn xoá bản ghi này?');" class="btn default btn-xs red curr_segment">
