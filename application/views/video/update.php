    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                Video <small><?php if(isset($permission[0])) echo 'Cập nhật '; else 'Thêm mới '; ?></small>
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="#">
                        <?php if(isset($row[0])) echo 'Cập nhật '; else  echo 'Thêm mới '; ?> Video
                        </a>
                    </li>
                </ul>
        ...
        <div class="row ">
            ...
            <form role="form" action="<?php echo base_url().'video/update/'.$id;?>" method="POST" enctype="multipart/form-data">
                <div class="col-md-9">
                            ...
                            <div class="form-body">
                               ...
                               <!--  <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" onclick="window.location = window.location.protocol + '//' + window.location.host + '/video/index'; return false;" class="w100 btn yellow"><i class="fa fa-ban"></i> Thoát</button>
                                </div>
