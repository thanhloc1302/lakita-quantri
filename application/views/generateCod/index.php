            ...
            <div class="pmh_method1 combo" style="<?php if ($generated == 1 && $activity == 2) echo 'display: block' ?>" >
                ...
                <form  action="<?php echo base_url() . "generateCod/generateCombo" ?>" method="post" name="c">
                    <div class="row-fluid2" style="padding-right: 42px;">
                        <div class="span12">
                            <div class="row-fluid1" style="margin-left: -20px;">
                                <input class="input-large LeadPanel_form_name khoahocdachon" type="text" required placeholder="Khóa đã chọn" name="khoahocdachon" id="number" />
                            </div>
                            <div class="dropdown">
                                <button class="" id="dLabel" type="button" data-toggle="dropdown" data-target="#" aria-haspopup="true" aria-expanded="false">
                                    chọn khóa học
                                ...
                                <div class="dropdown-menu" aria-labelledby="dLabel">
                                    ...
                                    foreach ($courses as $key => $cour) {
                                       ?>
                                            &nbsp;&nbsp;<input class="khoa_hoc" type="checkbox" value="<?php echo $cour['id']; ?>">&nbsp;&nbsp;<?php echo $cour['name']; ?><br>
                                            <?php
                                        }
