                				...
                				<form class="form-horizontal" role="form" action="<?php echo base_url();?>learn/delete" method="POST" id="form-del">
									...
									<tr class="odd gradeX">
										...
										<td class="center">
											...
											if(isset($chapter[0])) echo $chapter[0]['name']; else echo '...'; ?>											
										</td>
										...
										<td>
											<?php if($value['status']){ ?>
												<a href="<?php echo base_url().'learn/status/'.$value['id'].'/'.$value['status']; ?>" class="txt-center btn btn-sm green filter-cancel"><i class="fa fa-check"></i></a>												
											<?php }else{ ?>
												<a href="<?php echo base_url().'learn/status/'.$value['id'].'/'.$value['status']; ?>" class="txt-center btn btn-sm yellow filter-cancel"><i class="fa fa-times"></i></a>												
											<?php } ?>
