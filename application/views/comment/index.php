    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    Comments <small>Danh sách</small>
                </h3>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box light-grey">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-file-text"></i> Danh sách comments (<?php echo number_format($total); ?> bản ghi)
                        </div>
                    </div>
...
<?php foreach ($rows as $key => $value) { ?>
    ...
    <?php echo $value['id'] . '-'. $value['student_id'];?>

                                        </td>										

                                        <td>

                                            <?php foreach ($student as $key1 => $value1){ 
                                                if($value['student_id']== $value1['id']){
                                                    echo $value1['name'];
                                                }
                                            } ?>
    ...
    <?php foreach( $courses as $key2 => $value2){
        if($value['courses_id'] == $value2['id'] && $value['courses_id']!= 0 ){
            echo $value2['name'];
        }
    }
    ?>											
    ...
    <?php foreach ($learn as $key3 => $value3){
        if($value['learn_id'] == $value3['id']){
            echo $value3['name'];
        }
    }
    ?>											
    ...
    <?php echo $value['content'];?>
                                        ...
                                        <td>
 <?php echo date('H:i:s d/m/Y', $value['createdate']); ?>
                                        </td>

                                        <td class="center">

                                            <a href="<?php echo base_url() . 'learn/update/' . $value['id']; ?>" class="btn default btn-xs purple">
                                            ...
                                            <a href="<?php echo base_url() . 'learn/delete/' . $value['id']; ?>" onclick="return confirm('Bạn chắc chắn muốn xoá bản ghi này?');" class="btn default btn-xs red">
