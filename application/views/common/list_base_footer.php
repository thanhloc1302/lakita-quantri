...
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]><script src="<?php echo base_url();?>styles/assets/plugins/respond.min.js"></script>
...
<script type="text/javascript" src="<?php echo base_url();?>styles/assets/plugins/data-tables/jquery.dataTables.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>styles/assets/plugins/data-tables/DT_bootstrap.js"></script>
...
jQuery(document).ready(function() {       
   ...
   var str = pathname.substring(9);
    $('ul.page-sidebar-menu li').removeClass("active");
    var t = 'ul.page-sidebar-menu li.'+str+'';
    console.log(t);
   // alert(t);
    $(t).addClass("active");
