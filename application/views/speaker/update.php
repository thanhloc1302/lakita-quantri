    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                Giảng viên <small><?php if(isset($speaker[0])) echo 'Cập nhật '; else 'Thêm mới '; ?></small>
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="#">
                            <?php if(isset($speaker[0])) echo 'Cập nhật '; else 'Thêm mới '; ?> giảng viên
                        </a>
                    </li>
                </ul>
        ...
        <div class="row ">
            ...
            <form role="form" action="<?php echo base_url().'speaker/update/'.$id;?>" method="POST" enctype="multipart/form-data">
                <div class="col-md-9">
                        ...
                        <div class="portlet-body form">            
                            <div class="form-body">                                                                  
                                <div class="form-group">
                                    <label class="control-label"><i>Tên giảng viên</i></label>
                                ...
                                <div class="form-group">
                                    <label class="control-label"><i>Đơn vị</i></label>
                                    <div class="input-icon">
                                        <i class="fa fa-align-justify"></i>
                                        <input class="form-control" type="text" required="true" value="<?php if(isset($row[0])) echo $row[0]['organize'];?>" name="organize" />
                                    </div>
                                </div>
                        ...
                        <div class="portlet-body form">            
                            <div class="form-body">
                                ...
                                <br><div class="form-group">
                                    ...
                                    <button type="submit" onclick="window.location = window.location.protocol + '//' + window.location.host + '/' + 'speaker/index'; return false;" class="w100 btn yellow"><i class="fa fa-ban"></i> Thoát</button>
                                </div>
