...
define('WEBSITE', 'http://lakita.vn/');
define('UPLOAD', realpath(dirname(dirname(dirname(dirname(__FILE__))))).'/');

//config filemanager trong styles\assets\filemanager\config\config.php
